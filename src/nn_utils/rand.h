//借鉴自K神的llm.c https://github.com/karpathy/llm.c
/*
...
#define MERSENNE_STATE_M 397u // Offset used in the twist transformation
#define MERSENNE_STATE_N 624u // State array size
